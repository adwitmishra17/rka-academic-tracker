...
export function renderHpcPages(card) {
  ...
  const hd = (sub) => `<div class="hd"><img class="crest" src="${assetBase()}/crest-card.png" alt="" onerror="this.style.visibility='hidden'"><div><div class="name">RADHAKRISHNA ACADEMY</div><div class="sub">${esc(sub)}</div></div><div class="tag">${tag}</div></div>`
  ...
  <div class="hd" style="position:relative;z-index:1"><img class="crest" src="${assetBase()}/crest-card.png" alt="" onerror="this.style.visibility='hidden'"><div><div class="name">RADHAKRISHNA ACADEMY</div><div class="sub">Affiliated to CBSE, New Delhi${branchName ? ' · ' + esc(branchName) : ''} · Ballia</div></div></div>
